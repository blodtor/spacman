...
// splash screen - very first screen with SEGA eating animation
...
// 3 - STATE_SCREENSAVER - screensaver, very first screen with SEGA eating
 ...
 * SEGA
 *
 * Processing of buttons pressed by players during screensaver when eating SEGA text
