...
// '1 ИГРОК НЕ СЕТЕВАЯ!  ' (TEXT_1P_NO_LINK)  игра на одной приставке, во втором порту ни чего не обнаружено (controllerPort2Mode = MODE_SINGLE_PLAYER)
// '2 ИГРОКА НЕ СЕТЕВАЯ! ' (TEXT_2P_NO_LINK)  игра на одной приставке на двух контроллерах (controllerPort2Mode = MODE_MULTY_PLAYER)
